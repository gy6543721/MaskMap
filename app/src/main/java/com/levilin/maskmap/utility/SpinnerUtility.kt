...
object SpinnerUtility {
    ...
    fun getCountyIdByName(countyName: String): Int {
        return counties.indexOf(countyName)
    }

    fun getTownIdByName(countyName:String, townName: String): Int {
        val index = counties.indexOf(countyName)
        return counties[index].indexOf(townName)
    }
}